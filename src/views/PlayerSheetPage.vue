...
<template>
  ...
  <div v-if="player" class="max-w-4xl mx-auto">
    <h1
      class="text-4xl font-bold mb-6 text-center text-amber-500 font-['Cinzel'] drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]"
    >
      Fiche de Personnage
    </h1>
    ...
    >
      <div>
        ...
        <div
          v-if="player.place"
          class="bg-black/30 backdrop-blur-sm border border-amber-500/20 rounded-xl p-4 mb-3"
        >
    ...
    >
      ...
      <div class="flex flex-col gap-3">
        <div
          ...
          :key="quest.id"
          class="bg-black/30 backdrop-blur-sm border border-amber-500/20 rounded-xl p-4"
        >
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div
        class="bg-black/50 backdrop-blur-sm border-2 border-amber-500/40 rounded-xl shadow-xl p-6"
      >
